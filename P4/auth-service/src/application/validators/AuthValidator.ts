...
const ROLES_VALIDOS = ['Cliente', 'Agente', 'Admin'];
...
const reglaRol: ReglaValidacion = (d) => {
  if (d.rol === undefined) return null;
...
export class AuthValidator {
  static validarRegistro(datos: DatosEntrada): void {
    this.ejecutar(datos, [reglaNombre, reglaCorreo, reglaContrasena, reglaRol]);
  }
