...
CREATE TABLE IF NOT EXISTS usuarios (
  ...
  -- Cifrados con AES-256-GCM (ver AesCipher.ts). Nunca se guardan en texto plano.
  nombre_cifrado TEXT NOT NULL,
  correo_cifrado TEXT NOT NULL,
  contrasena_cifrada TEXT NOT NULL,
  -- HMAC-SHA256 determinístico del correo, únicamente para poder
  -- buscarlo/indexarlo sin tener el correo en texto plano (ver hashCorreo.ts).
